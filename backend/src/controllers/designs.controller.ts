// src/controllers/designs.controller.ts
...
export const uploadDesign = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const getMyDesigns = async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
    const designRepo = AppDataSource.getRepository(CustomDesign);
